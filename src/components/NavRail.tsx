...
import { RulebookIcon, GameIcon, ArmyIcon, SettingsIcon } from '../design/icons';
...
// A slim deeper-parchment column: emblem → Home at the top, the three main sections, and
// Settings pinned at the bottom. The contextual sidebar (per screen) sits to its right.

// Geen 'play' meer: de turn-companion is geen tab maar een modus die je vanuit de Rulebook opent
// (Joost, 12-09).
export type NavTab = 'browse' | 'game' | 'army' | 'settings';
